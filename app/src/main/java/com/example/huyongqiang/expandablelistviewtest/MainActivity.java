package com.example.huyongqiang.expandablelistviewtest;
...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);  //设置为无标题
        ...
        getExpandableListView().setBackgroundResource(R.mipmap.ic_launcher);
    ...
    class ContactsInfoAdapter extends BaseExpandableListAdapter {
        ...
        public TextView getGenericView(String s) {
            ...
            //设置长宽
            AbsListView.LayoutParams lp = new AbsListView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 190);
